...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dividendcash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dividendcash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Dividendcash features */
        {"dividendcash", "masternode", &masternode, true, true, false},
        {"dividendcash", "listmasternodes", &listmasternodes, true, true, false},
        {"dividendcash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dividendcash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dividendcash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dividendcash", "masternodedebug", &masternodedebug, true, true, false},
        {"dividendcash", "startmasternode", &startmasternode, true, true, false},
        {"dividendcash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dividendcash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dividendcash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dividendcash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dividendcash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dividendcash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dividendcash", "mnbudget", &mnbudget, true, true, false},
        {"dividendcash", "preparebudget", &preparebudget, true, true, false},
        {"dividendcash", "submitbudget", &submitbudget, true, true, false},
        {"dividendcash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dividendcash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dividendcash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dividendcash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dividendcash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dividendcash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dividendcash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dividendcash", "checkbudgets", &checkbudgets, true, true, false},
        {"dividendcash", "mnsync", &mnsync, true, true, false},
        {"dividendcash", "spork", &spork, true, true, false},
        {"dividendcash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"dividendcash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use dividendcashd, or the -server option to dividendcash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> dividendcash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29998/\n";
}
